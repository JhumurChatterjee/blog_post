...
Devise.setup do |config|
  ...
  config.mailer_sender = "Blog Post <jhumurchatterjee1996@gmail.com>"
  ...
  if Rails.env.production?
    config.pepper = ENV["PEPPER_KEY"]
  else
    config.pepper = Rails.application.credentials.pepper_secret_key
  end
